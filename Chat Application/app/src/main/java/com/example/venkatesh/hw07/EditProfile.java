...
public class EditProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageref = storage.getReferenceFromUrl("gs://hw07-e855b.appspot.com/");
                ...
                for (DataSnapshot postSnapshot: dataSnapshot.getChildren()) {
                    ...
                    if(tempprof.getEmail().equals(FirebaseAuth.getInstance().getCurrentUser().getEmail()))
                    {
                        ...
                        if(tempprof.getImage()!=null)
                        {
                            ...
                            FirebaseStorage storage = FirebaseStorage.getInstance();
                            StorageReference storageReference = storage.getReferenceFromUrl("gs://hw07-e855b.appspot.com/");
